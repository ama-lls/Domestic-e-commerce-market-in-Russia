...
- Написаны необходимые SQL-запросы и создано представление, на основании которого разработан интерактивный [отчет](<[(https://disk.yandex.ru/i/AO4pkaRrvNThfQ)]>) в Power BI Desktop.
