...
- Написаны необходимые SQL-запросы и создано представление, на основании которого разработан интерактивный [отчет](https://disk.yandex.ru/i/U269BhiLpk6Kfw) в Power BI Desktop.
- Проведен анализ рынка внутренней интернет-торговли в России 2022 VS 2021.
